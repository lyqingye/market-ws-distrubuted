...
public interface ChannelProcessor {
   ...
   * @return 是否主题匹配
   */
  boolean doSubIfChannelMatched(Context ctx, String ch, Session session, JsonObject json);
   ...
   * @return 是否主题匹配
   */
  boolean doUnSubIfChannelMatched(Context ctx, String ch, Session session, JsonObject json);
}

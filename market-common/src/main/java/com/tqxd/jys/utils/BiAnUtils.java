...
public final class BiAnUtils {
  ...
  public static String toKlineSub(String symbolId, BiAnPeriod period) {
    return String.format("%s@kline_%s", symbolId, period.getSymbol());
  }

  public static String toKlineSymbolDeMappingKey(String symbolId, BiAnPeriod period) {

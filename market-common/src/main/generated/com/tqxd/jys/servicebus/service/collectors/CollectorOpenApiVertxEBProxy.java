...
public class CollectorOpenApiVertxEBProxy implements CollectorOpenApi {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public CollectorOpenApiVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public CollectorOpenApiVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
    ...
    _vertx.eventBus().<JsonArray>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        handler.handle(Future.succeededFuture(res.result().body().stream()
          .map(v -> v != null ? new com.tqxd.jys.servicebus.payload.CollectorStatusDto((JsonObject)v) : null)
